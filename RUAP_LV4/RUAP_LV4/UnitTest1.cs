...
namespace SeleniumTests
{
    ...
    public class UntitledTestCase
    {
        ...
        public void TheUntitledTestCaseTest()
        {
            ...
            driver.FindElement(By.Id("input-email")).SendKeys("sdraga11s@etfos.hr");
            ...
            driver.FindElement(By.Id("input-firstname")).SendKeys("srdan1111");
            driver.FindElement(By.Id("input-lastname")).Click();
            driver.FindElement(By.Id("input-lastname")).Clear();
            driver.FindElement(By.Id("input-lastname")).SendKeys("dragas1111"+ numb); // dodaje random number 
